            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        ...
                        <div class="card-body">
                            <p class="card-text">{{$product->nom}}<br>{{$product->description}} <br>
                                <strong>Catégorie :<a href="{{route('voir_produits_par_categorie',['id'=>$product->category->id])}}">{{ $product->Category->nom }}</a></strong></p>
